...
Start using the email service at https://inboxs.me/emails !
...
curl -X POST \
  ...
  -d '{
    "emailAddress": "your-suffix@inboxs.me"
  }' \
  https://inboxs.me/api/v1/email
```
...
```json
{
  "emailAddress": "your-suffix@inboxs.me" // required, suffix must be at least 5 characters
}
```
...
curl -X GET \
  -H "wrdo-api-key: YOUR_API_KEY" \
  "https://inboxs.me/api/v1/email/inbox?emailAddress=your-suffix@inboxs.me&page=1&size=10"
```
