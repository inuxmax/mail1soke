...
1. **Access the Chat Room**
   - Open [https://inboxs.me/chat](https://inboxs.me/chat) in your browser.
...
4. **Share Your Room**
   - Click the **Share Room** button next to "Your ID" to copy a URL (e.g., `https://inboxs.me/chat?room=abc123-xyz789`).
...
This WRoom offers a lightweight, user-friendly solution for real-time communication. Enjoy chatting and sharing with your peers at [https://inboxs.me/chat](https://inboxs.me/chat)!
...
1. **访问聊天室**
   - 在浏览器中打开 [https://inboxs.me/chat](https://inboxs.me/chat)。
...
4. **分享您的房间**
   - 点击“Your ID”旁边的 **Share Room（分享房间）** 按钮，复制包含您 Peer ID 的 URL（例如 `https://inboxs.me/chat?room=abc123-xyz789`）。
...
**WRoom** 提供了一个轻量级、用户友好的实时通信解决方案。立即访问 [https://inboxs.me/chat](https://inboxs.me/chat)，享受与您的朋友聊天和分享吧！