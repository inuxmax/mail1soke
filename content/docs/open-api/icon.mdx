...
```bash 
![example](https://Mail1s.net/api/v1/icon?type=text&w=400&h=35&value=🥰You make something cool, you can name it whatever you want&animate=true&fillType=Linear&primaryColor=%23FC466B&secondaryColor=%233F5EFB&angle=45&radialGlare=false&radius=8&strokeSize=0&strokeColor=%23FFFFFF&strokeOpacity=100&color=%23FFFFFF&size=15&family=cursive)
```
...
```html
<img
  src="https://Mail1s.net/api/v1/icon?type=text&w=400&h=35&value=🥰You make something cool, you can name it whatever you want&animate=true&fillType=Linear&primaryColor=%23FC466B&secondaryColor=%233F5EFB&angle=45&radialGlare=false&radius=8&strokeSize=0&strokeColor=%23FFFFFF&strokeOpacity=100&color=%23FFFFFF&size=15&family=cursive"
  alt="Your SVG Icon"
/>
```
