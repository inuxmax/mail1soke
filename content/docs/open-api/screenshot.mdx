...
API URL:
```bash
https://inboxs.me/api/v1/scraping/screenshot?url=https://vmail.dev&key=your_api_key
```
...
[https://inboxs.me/api/v1/scraping/screenshot?url=https://vmail.dev&key=example_key](https://inboxs.me/api/v1/scraping/screenshot?url=https://vmail.dev&key=b6e1c218-c090-434d-ba3f-97fb48fbccd9)

Here are some example combinations of query parameters:

```bash
https://inboxs.me/api/v1/scraping/screenshot?url=https://vmail.dev&key=example_key
https://inboxs.me/api/v1/scraping/screenshot?url=https://vmail.dev&key=example_key&width=500&height=500
https://inboxs.me/api/v1/scraping/screenshot?url=https://vmail.dev&key=example_key&viewportWidth=1920&viewportHeight=1080&isFullPage=true
https://inboxs.me/api/v1/scraping/screenshot?url=https://vmail.dev&key=example_key&viewportWidth=1920&viewportHeight=1080&isFullPage=true&isDarkMode=true
```
...
```html
<img
  src="https://inboxs.me/api/v1/scraping/screenshot?url=https://oiov.dev&key=example_key"
