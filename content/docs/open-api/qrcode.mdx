...
**Base URL:**
https://inboxs.me/api/v1/scraping/qrcode
...
```bash
https://inboxs.me/api/v1/scraping/qrcode?key=your_api_key&url=https://example.com
```
...
```bash
https://inboxs.me/api/v1/scraping/qrcode?key=your_api_key&url=https://example.com&size=400&fgColor=%230066FF&bgColor=%23FFFF00
```

### With Custom Logo and High Error Correction
Add a custom logo and use high error correction (`H`):
```bash
https://inboxs.me/api/v1/scraping/qrcode?key=your_api_key&url=https://example.com&logo=https://your-logo-url.com/logo.png&level=H
```

### Hide Logo and Add Margin
Hide the logo and add a larger margin:
```bash
https://inboxs.me/api/v1/scraping/qrcode?key=your_api_key&url=https://example.com&hideLogo=true&margin=10
```
...
```html
<img
  src="https://inboxs.me/api/v1/scraping/qrcode?key=your_api_key&url=https://example.com&size=300&fgColor=%230000FF"
...
## Support
For issues or questions, contact support at support@inboxs.me or visit our Help Center.