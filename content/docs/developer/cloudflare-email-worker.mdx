...
```json
"vars": {
  "APP_API_URL": "https://inboxs.me/api/v1/email-catcher"
},
"r2_buckets": [
  {
    "binding": "R2_BUCKET",
...
- The Worker sends a POST request to https://inboxs.me/api/v1/email-catcher with the email details and attachment URLs.
