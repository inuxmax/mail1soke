...
inboxs.me now supports multiple cloud storage providers:
...
[
  {
    "AllowedOrigins": [
      "http://localhost:3000",
      "https://inboxs.me" // Replace with your domain
    ],
    "AllowedMethods": [
      "GET",
      "PUT",
